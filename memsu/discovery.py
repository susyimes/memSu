...
def capabilities_manifest() -> dict[str, Any]:
    return {
        ...
        "commands": {
            ...
            "advance_adapter_git": f"{ENTRYPOINT} advance run --adapter git-activity --repo-path .",
            "advance_runs": f"{ENTRYPOINT} advance runs",
            "advance_worklines": f"{ENTRYPOINT} advance worklines",
            "advance_opportunities": f"{ENTRYPOINT} advance opportunities",
